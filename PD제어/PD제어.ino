...
// Servo speed control
#define _SERVO_ANGLE 50.0 // [3114] 서보각도
#define _SERVO_SPEED 60.0 //[3104] 서보속도
...
// PID parameters
#define _KP 1.5//0.05//1.5// [3103] KP값은 개인이 설정
#define _KD 200//0.2
