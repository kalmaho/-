...
#define PIN_LED 9
// Framework setting
#define _DIST_TARGET 400 //[3104] 탁구공을 위치 시킬 목표 
#define _DIST_MIN 130 //[3117] 거리 최소값 //[3104] 측정 거리 최소치 
#define _DIST_MAX 540//[3117] 거리 최대값//[3104] 측정 거리 최대치
...
#define _DUTY_MAX 2100     //[3100] 최대 서보 위치


// Servo speed control
#define _SERVO_ANGLE 90.0 // [3114] 서보각도
#define _SERVO_SPEED 80.0 //[3104] 서보속도
...
// PID parameters
#define _KP 0.7 // [3103] KP값은 개인이 설정
